...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { action: @habit.action, count: @habit.count, trigger: @habit.trigger } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { action: @habit.action, count: @habit.count, trigger: @habit.trigger } }
